...
export function initialModel(): Model {
  return {
    cards: [
      ...
      { id: 6, column: "todo", title: asciiBytes("Add task retry backoff"), ticketNumber: 1846, assignee: "claude", avatarId: 2 },
      { id: 7, column: "todo", title: asciiBytes("Surface tool approval state"), ticketNumber: 1847, assignee: "openai", avatarId: 1 },
      { id: 8, column: "doing", title: asciiBytes("Stream partial agent output"), ticketNumber: 1848, assignee: "claude", avatarId: 2 },
      { id: 9, column: "done", title: asciiBytes("Keep session replay deterministic"), ticketNumber: 1849, assignee: "openai", avatarId: 1 },
      { id: 10, column: "done", title: asciiBytes("Capture automation traces"), ticketNumber: 1850, assignee: "claude", avatarId: 2 },
    ],
    nextId: 11,
    droppedCount: 0,
    chromeLeading: 0,
